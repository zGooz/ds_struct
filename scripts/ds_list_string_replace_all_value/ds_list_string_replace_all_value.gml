  ...
  /// @function ds_list_string_replace_all_value(list, sub_str, mew_sub_str, value)
  ...
  /*
      description :
        ...
        The script uses the "string_replace_all" function for all 
  ...
  */
  ...
  for (var i = 0; i < ds_list_size(list); i++;)
  {
    ...
    if is_string(value) && (cmp_val == value)
    {
      ...
      ds_list_replace_all(list, i, value);
    }
  }
